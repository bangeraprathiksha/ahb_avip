`ifndef AHBVIRTUALUWRITEFOLLOWEDBYREADSEQUENCE_INCLUDED_
`define AHBVIRTUALUWRITEFOLLOWEDBYREADSEQUENCE_INCLUDED_

class AhbVirtualuWriteFollowedByReadSequence extends AhbVirtualBaseSequence;
  `uvm_object_utils(AhbVirtualuWriteFollowedByReadSequence)
  ...
  extern function new(string name ="AhbVirtualuWriteFollowedByReadSequence");
  extern task body();

endclass : AhbVirtualuWriteFollowedByReadSequence

function AhbVirtualuWriteFollowedByReadSequence::new(string name ="AhbVirtualuWriteFollowedByReadSequence");
  super.new(name);
endfunction : new

task AhbVirtualuWriteFollowedByReadSequence::body();
  super.body();
