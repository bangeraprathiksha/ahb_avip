`ifndef AHBVIRTUALHMASTLOCK0SEQUENCE_INCLUDED_
`define AHBVIRTUALHMASTLOCK0SEQUENCE_INCLUDED_

class AhbVirtualHmastlock0Sequence extends AhbVirtualBaseSequence;
  `uvm_object_utils(AhbVirtualHmastlock0Sequence)
  ...
  extern function new(string name ="AhbVirtualHmastlock0Sequence");
  extern task body();

endclass : AhbVirtualHmastlock0Sequence

function AhbVirtualHmastlock0Sequence::new(string name ="AhbVirtualHmastlock0Sequence");
  super.new(name);
endfunction : new

task AhbVirtualHmastlock0Sequence::body();
  super.body();
